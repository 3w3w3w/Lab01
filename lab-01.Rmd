...
**Stands for 'not applicable', and this is the answer as there are several values in n_2021 that are N/A, meaning they were inputted as data other than doubles.**
...
**The removed data values were possibly much smaller, and that is the reason for the skew.**
...
```{r Ex_m}
visitors_with_nations %>%
  select(attraction, admission, setting, region, nation, n_2021, n_2022) %>%
  mutate(proportion = )
